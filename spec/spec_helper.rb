...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    stub_request(:post, "https://api.github.com/user/repos").
      ...
      stub_request(:post, "https://github.com/login/oauth/access_token").
           with(:body => {"client_id"=>"Iv1.35cef91193676961", "client_secret"=>"2c8e6b313b4dd6593a594e5c2ffa276b5e6492c8
  ", "code"=>"20"},
                :headers => {'Accept'=>'application/json', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
  'Content-Type'=>'application/x-www-form-urlencoded', 'User-Agent'=>'Faraday v0.9.1'}).
